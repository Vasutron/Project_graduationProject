...
$sql = "INSERT INTO equipment (DeviceID,DeviceName,DeviceType,DeviceModel,SerialNumber,Manufacturer,DateOfPurchase,WarrantyExpirationDate)
        VALUES ('$deviceid', '$devicename', '$devicetype', '$devicemodel', '$serialnumber', '$manufacturer', '$datepurchase', '$warranty')";

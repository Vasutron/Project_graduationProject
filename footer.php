<div class="container mt-5">
    <div class="row">
        <div class="col-md-4">
            ...
            <a class="btn btn-secondary" href="status.php" role="button">ตรวจสอบสถานะ</a>
            <a class="btn btn-secondary" href="device.html" role="button">ค้นหาข้อมูลนาฬิกาของคุณ</a>
        </div>
        <div class="col-md-4">
            <div class="container col mt-2 md-0">
            ...
            <a class="btn btn-secondary" href="repair.php" role="button">ข้อมูลเพิ่มเติม</a>
        </div>
        <div class="col-md-4">
            <div class="container col mt-2 md-0">
            ...
            <a class="btn btn-secondary" href="contact.php" role="button">Learn More</a>
        </div>
    </div>
</div>